        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group d-flex mb-3">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="apellidoPatCliente" class="form-control" placeholder="Apellido Paterno">
                    </div>                      
                </div>
                <div class="form-group d-flex mb-3">
                    <div class="col-sm-6 mr-3">
                        <input type="text" name="apellidoMatCliente" class="form-control" placeholder="Apellido Materno">
                    </div>
                    <div class="col-sm-6">
