                ...
                <form action="Controlador?menu=Clientes" method="POST">
                    ...
                    <div class="form-group d-flex mb-3">
                        <div class="col-sm-6 mr-3">
                            <input type="text" name="txtNombres" value="${cliente.getNom()}" class="form-control" placeholder="Nombres" required>
                        </div>
                        <div class="col-sm-6">
                            <input type="text" name="txtApep" value="${cliente.getApep()}" class="form-control" placeholder="Apellido Paterno" required>
                        </div>                      
                    </div>
                    <div class="form-group d-flex mb-3">
                        <div class="col-sm-6 mr-3">
                            <input type="text" name="txtApem" value="${cliente.getApem()}" class="form-control" placeholder="Apellido Materno" required>
                        </div>
                        <div class="col-sm-6">
                            <input type="text" name="txtTel" value="${cliente.getTel()}" class="form-control" placeholder="Teléfono" pattern="[0-9]{9}" title="Debe contener 9 números" required>
                        </div>                             
                    </div>
